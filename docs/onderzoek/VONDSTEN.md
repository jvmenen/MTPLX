...
| 32 | Vijf takken staan alleen lokaal op de Mac, niet in de fork: `feat/prefix-reuse-block`, `refactor/prefix-helpers`, `feat/chat-encode-segment-memo`, `fix/bank-ceiling-peak-decay`, `test/classifier-live` | [README](README.md) | Veiligstellen door te pushen naar de fork (na akkoord Jeroen; de fork is openbaar) |
