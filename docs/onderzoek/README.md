...
| `feat/faster-prompt-scoring` | Snellere scoreroute | Lokaal gecommit (dc9c0e3e, 736d9480), echte toets loopt |
| `feat/chat-encode-segment-memo` | Chat-encode-memo per segment | In ontwikkeling |
